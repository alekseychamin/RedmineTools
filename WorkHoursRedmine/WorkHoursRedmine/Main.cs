...
namespace WinRedminePlaning
{
    public partial class Main : Form
    {
        ...
        private void but_SaveExcel_Click(object sender, EventArgs e)
        {
            ...
            if ((listViewUser.Items.Count != 0) & (listViewUser.SelectedItems.Count != 0))
            {
            ...
            if (userRedmine != null)
                manager.excelMethods.MakeSheetWorkingHours(userRedmine, Application.StartupPath, activityNotWorkHours);
        }
